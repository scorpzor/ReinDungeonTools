...
function LibCompress:CompressHuffman(uncompressed)
	...
	sort(leafs,
		...
		function(a, b) if a.weight < b.weight then return true elseif a.weight > b.weight then return false else return nil end end)
...
function LibCompress:GetEncodeTable(reservedChars, escapeChars, mapChars)
	...
	local encode_func = assert(loadstring(
